...
import {createAccreditorApiMethod} from "../lib/api/accreditor";

export default (() => {
    return <Theme theme={theme}>
        <GlobalPageStyles pageUrl={"accreditorCertifier"}/>
        <Helmet>
            <title>
                Accreditor | Certsystem
            </title>
            <meta name={"description"} content={""}/>
            <meta property={"og:title"} content={"Control | CertSystem"}/>
            ...
            >
                ...
                >
                    <Input
                        ...
                        position="static"
                        flex-direction="row"
                        placeholder="Введите подразделение компании"
